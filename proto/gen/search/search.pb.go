...
const file_search_search_proto_rawDesc = "" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x1b.inama.search.v1.SearchTypeR\x04type\x12\x14\n" +
	...
	"\tmedia_url\x18\x04 \x01(\tR\bmediaUrl\"\x97\x01\n" +
	"\x0eSearchResponse\x121\n" +
	"\x05users\x18\x01 \x03(\v2\x1b.inama.search.v1.UserResultR\x05users\x121\n" +
	"\x05posts\x18\x02 \x03(\v2\x1b.inama.search.v1.PostResultR\x05posts\x12\x1f\n" +
